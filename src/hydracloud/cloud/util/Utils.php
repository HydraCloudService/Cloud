...
final class Utils {
    ...
    public static function downloadPlugins(): void {
        ...
        if ($downloadServerPlugin) {
            ...
            NetUtils::download("https://github.com/HydraCloudService/CloudBridge/releases/latest/download/CloudBridge.phar", $serverPluginsPath . "CloudBridge.phar");
        ...
        if ($downloadProxyPlugin) {
            ...
            NetUtils::download("https://github.com/HydraCloudService/CloudBridge-Proxy/releases/latest/download/CloudBridge.jar", $proxyPluginsPath . "CloudBridge.jar");
