...
namespace hydracloud\cloud\command\impl\web;
...
use hydracloud\cloud\command\argument\def\WebAccountArgument;
...
use hydracloud\cloud\setup\impl\WebAccountSetup;
