...
namespace hydracloud\cloud\update;
...
final class UpdateChecker {
    ...
    private function checkServerPlugin(): void {
        try {
            ...
            $ch = curl_init("https://api.github.com/repos/HydraCloudService/CloudBridge/releases/latest");
            curl_setopt_array($ch, [
                    CURLOPT_SSL_VERIFYPEER => false,
                    CURLOPT_SSL_VERIFYHOST => false,
                    CURLOPT_RETURNTRANSFER => true,
    ...
    private function checkProxyPlugin(): void {
        try {
            $downloadNewest = false;
            $ch = curl_init("https://api.github.com/repos/HydraCloudService/CloudBridge-Proxy/releases/latest");
            curl_setopt_array($ch, [
                    CURLOPT_SSL_VERIFYPEER => false,
                    CURLOPT_SSL_VERIFYHOST => false,
                    CURLOPT_RETURNTRANSFER => true,
