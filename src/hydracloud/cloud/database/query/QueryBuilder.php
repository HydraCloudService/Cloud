...
final class QueryBuilder {
    ...
    public function select(array $join, array|string $columns = null, $where = null): self {
        $table = $this->table;
    ...
    public function get(array $join = null, array|string $columns = null, array $where = null): self {
        $table = $this->table;
    ...
    public function rand(array $join = null, array|string $columns = null, array $where = null): self {
        $table = $this->table;
